...
<section class = "container m-3">
    ...
    <form action="index.php?act=editProduct" method= "post" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input name = "price" type="number" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value = "<?=$price ?>">
        </div>
        <div>
            <label for="">Price Sale</label>
            <input name = "price_sale" type="number" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" value = "<?=$price_sale ?>">
        </div>
        <div>
        ...
        <div class = "mb-5 mt-2">
            ...
            <a href="index.php?act=listProduct"><button class="btn btn-info" type = "button" value = "List addProduct">List Product</button></a>
        </div>
    </form>
</section>