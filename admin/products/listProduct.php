    <section class="container mt-3">
        ...
        <form action="index.php?act=removeSelectedProducts" method="post">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th> <button class="btn btn-danger mt-3" name="deleteSelectedProducts">Remove</button>
                        </th>
                        <th scope="col">#</th>
                ...
                <tbody>
                    ...
                    if (isset($products) && !empty($products)) {
                        foreach ($products as $key => $value) {
                            ...
                            echo '
            <tr>
            <th><input class="form-check-input" type="checkbox" name="selectedProducts[]" value="' . $id . '" id="productCheckbox' . $id . '"></th>
